...
<section class="relative min-h-[85vh] flex items-center overflow-hidden">
    ...
    <div class="absolute inset-0">
        <img src="{{ asset('images/Plants/Boston_Fern.webp') }}"
             alt="Lush Boston Fern plant — FlowerPot collection"
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
        <div class="max-w-xl">
            <span class="inline-block bg-amber-400/20 border border-amber-400/40 text-amber-300 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-6">
            ...
            <p class="text-green-100 text-lg leading-relaxed mb-10 max-w-md">
                Discover our handpicked collection of beautiful pots and vibrant plants. Transform every corner of your home into a green paradise.
            </p>
            <div class="flex flex-wrap gap-4">
                <a href="{{ route('products.index') }}" class="bg-amber-400 hover:bg-amber-300 text-stone-900 font-bold px-8 py-3.5 rounded-xl text-sm shadow-lg transition hover:-translate-y-0.5 hover:shadow-amber-400/30 hover:shadow-xl">
                    Explore Collection
                </a>
                <a href="{{ route('products.plants') }}" class="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-semibold px-8 py-3.5 rounded-xl text-sm transition backdrop-blur-sm">
                    View Plants →
                </a>
            </div>
        </div>
...
<section class="py-20 px-4 bg-stone-50">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-12">
            ...
            <p class="text-stone-500 mt-3 max-w-lg mx-auto">Find the perfect pot or plant to breathe life into every corner of your home</p>
        </div>

        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-5">
            <a href="{{ route('products.pots') }}" class="group relative rounded-2xl overflow-hidden aspect-square shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <a href="{{ route('products.ceramics') }}" class="group relative rounded-2xl overflow-hidden aspect-square shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <a href="{{ route('products.cement') }}" class="group relative rounded-2xl overflow-hidden aspect-square shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <a href="{{ route('products.mud') }}" class="group relative rounded-2xl overflow-hidden aspect-square shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <a href="{{ route('products.plants') }}" class="group relative rounded-2xl overflow-hidden aspect-square shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 col-span-2 sm:col-span-1">
...
<section class="py-20 px-4 bg-white">
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10">
            ...
            <a href="{{ route('products.index') }}" class="text-green-700 hover:text-green-800 font-semibold text-sm flex items-center gap-1 whitespace-nowrap group">
                View all
...
<section class="py-20 px-4 bg-stone-50">
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-12">
            ...
            <p class="text-stone-500 mt-3 max-w-lg mx-auto">We're committed to bringing the best nature has to offer, right to your door</p>
        </div>
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group hover:-translate-y-1">
                ...
                <div class="p-6 text-center">
                    <div class="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center mx-auto mb-3">
                        <svg class="w-5 h-5 text-green-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8l1.5 10.5A2 2 0 008.5 20h7a2 2 0 002-1.5L19 8"/></svg>
                    </div>
                    <h3 class="font-bold text-stone-800 text-base mb-2">Free Delivery</h3>
                    <p class="text-stone-500 text-sm leading-relaxed">Free home delivery on all orders above Rs. 1500. We deliver across Pakistan.</p>
                </div>
            </div>
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group hover:-translate-y-1">
                <div class="h-52 overflow-hidden">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-stone-500 text-sm leading-relaxed">All our plants are naturally grown. Healthy, vibrant, and ready for your home.</p>
                </div>
            </div>
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group hover:-translate-y-1">
                <div class="h-52 overflow-hidden">
                ...
                <div class="p-6 text-center">
                    <div class="w-10 h-10 bg-pink-100 rounded-xl flex items-center justify-center mx-auto mb-3">
                        <svg class="w-5 h-5 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"/></svg>
                    </div>
                    <h3 class="font-bold text-stone-800 text-base mb-2">Gift Wrapping</h3>
                    <p class="text-stone-500 text-sm leading-relaxed">Special gift packaging available. Perfect for birthdays, anniversaries, and more.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="relative py-24 px-4 overflow-hidden">
    ...
    <div class="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <a href="{{ route('products.index') }}" class="inline-block bg-amber-400 hover:bg-amber-300 text-stone-900 font-bold px-10 py-4 rounded-xl text-base shadow-xl transition hover:-translate-y-0.5">
            Shop the Collection
        </a>
    </div>
</section>
